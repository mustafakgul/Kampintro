...
namespace odev
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine(diziadi[i].UrunAdi + "--->" + diziadi[i].UrunGramaji + "--->" + diziadi[i].Fiyati);
            }
            ...
            {
                Console.WriteLine(donguadi.UrunAdi + "-->" + donguadi.UrunGramaji + "-->" + donguadi.Fiyati);
            }
            ...
            {
                Console.WriteLine(diziadi[j].UrunAdi + "->" + diziadi[j].UrunGramaji + "->" + diziadi[j].Fiyati); j++;
